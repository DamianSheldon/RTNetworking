#
#  Be sure to run `pod spec lint CTPersistance.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    CTNetworking is an iOS discrete HTTP API calling framework based on AFNetworking.
                   DESC
  ...
  s.source       = { :git => "https://github.com/DamianSheldon/RTNetworking.git", :tag => s.version.to_s }
